...
[← Previous Part 1](2025-10-23-nasdaq-fcf) | [Next → Part 3 — Walk-Forward Modeling & Conclusions](2025-11-05-nasdaq-fcf-part3)
...
- **FCF flip** — when a company changes from negative to positive FCF (or vice versa) between years.  
  *Why it matters:* flips can signal improvement or deterioration in financial health, but in this dataset they were too rare to form reliable patterns.

- **Sector-neutral** — comparing companies only within the same industry.  
  *Why it matters:* prevents results from being skewed by one hot or cold sector dominating performance.

- **Decile / Quartile analysis** — sorting companies into ten (decile) or four (quartile) equal groups by a variable like FCF.  
  *Why it matters:* shows whether stronger fundamentals consistently align with better returns across groups.

- **Benchmark return** — the average return of all eligible stocks in a given year.  
  *Why it matters:* serves as a baseline for comparing individual or group performance.

- **Panel (company-year panel)** — a dataset where each row represents one company in one year.  
  *Why it matters:* makes it possible to track changes over time and compare results consistently across firms.
...
In the final part of this series, we’ll move from averages and group patterns to **testing prediction directly**.  
We’ll build a simple walk-forward **XGBoost model** that tries to rank future winners based on fundamentals alone. Then we'll test whether Free Cash Flow adds any predictive power once we train it properly.

Also, if you have any questions or suggestions, please feel free to tell me anything at mohitmohanraj05@gmail.com

[Next → Part 3 — Walk-Forward Modeling & Conclusions](2025-11-05-nasdaq-fcf-part3)
